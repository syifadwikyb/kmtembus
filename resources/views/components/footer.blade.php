<div class="static bottom-0 mx-auto bg-primary mt-10 text-white">
    <div class="mx-auto border-b-white border-y">
        <div class="container mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5 p-5">            
                ...
                <div class="col-span-1 md:col-span-1 lg:col-span-3">
                    <ul class="list-none space-y-2 lg:space-y-4 text-center lg:text-left">
                        <li>
                            <a href="#" class="text-base lg:text-xl text-white hover:underline hover:text-blue-600 transition-colors duration-300">
                                Tentang KM TEMBUS
                            </a>
                        </li>
                        <li>
                ...
                <div class="col-span-1 md:col-span-2 lg:col-span-5">
                    <iframe class="w-full h-48 md:h-60 lg:h-72"
                    ...
                    <p class="text-sm lg:text-lg text-white mt-4 text-center lg:text-left">
    ...
    <p class="text-sm lg:text-lg text-center p-4 text-white">Hak Cipta © 2024 KM_TEMBUS. Terima
