...
<header id="navbar" class="sticky top-0 z-50 bg-transparent transition-all duration-300">
    <nav class="container mx-auto flex items-center justify-between p-6" aria-label="Global">
        ...
        <div id="menu"
            ...
            <a href="/"
                class="text-sm md:text-base lg:text-lg font-semibold text-gray-900 px-6 py-2 hover:rounded-md hover:bg-primary hover:text-white transition-all duration-300">Beranda</a>
            <a href="/recomendations"
                class="text-sm md:text-base lg:text-lg font-semibold text-gray-900 px-6 py-2 hover:rounded-md hover:bg-primary hover:text-white transition-all duration-300">Rekomendasi</a>
            <div class="relative inline-block">
                <a href="#" id="activityButton"
                    class="flex items-baseline space-x-2 text-sm md:text-base lg:text-lg font-semibold text-gray-900 px-6 py-2 hover:rounded-md hover:bg-primary hover:text-white transition-all duration-300">
                    <span>Aktivitas</span>
            ...
            <a href="/bidang-program-kerja"
                class="text-sm md:text-base lg:text-lg font-semibold text-gray-900 px-6 py-2 hover:rounded-md hover:bg-primary hover:text-white transition-all duration-300">Bidang
                & Program Kerja</a>
            <a href="/contact"
                class="text-sm md:text-base lg:text-lg font-semibold text-gray-900 px-6 py-2 hover:rounded-md hover:bg-primary hover:text-white transition-all duration-300">Kontak</a>
        </div>
    </nav>
</header>
